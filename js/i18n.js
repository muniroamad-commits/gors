...
const I18N = (() => {
  ...
  const UI = {
    ...
    chart_prdo: { pt: 'PrDO — Resultados', en: 'PrDO — Results' },
    chart_prdo_sub: { pt: 'Progresso de cada indicador de Programa', en: 'Progress of each Program indicator' },
    chart_pdo: { pt: 'PDO — Resultados', en: 'PDO — Results' },
    chart_pdo_sub: { pt: 'Progresso de cada indicador de Projecto', en: 'Progress of each Project indicator' },
